...
<section class="py-12">
    <div class="max-w-screen-2xl mx-auto px-6">
        <div class="bg-gradient-to-r from-green-100 to-emerald-100 rounded-2xl p-10 text-center border border-green-200">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">Get in Touch</h1>
            <p class="text-gray-700 text-lg mb-6">We'd love to hear from you. Send us a message and we'll respond as soon as possible.</p>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <p class="text-gray-600 mb-8">Feel free to reach out to us through any of the following channels. We're here to help!</p>
                </div>
                    ...
                    <div class="bg-white rounded-xl border shadow-sm p-6 hover:shadow-md transition-shadow">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">123 Shopping Street<br>City, State 12345<br>United States</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border shadow-sm p-6 hover:shadow-md transition-shadow">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">support@minimart.com</p>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <div class="flex gap-4">
                                    <a href="#" class="w-10 h-10 rounded-lg bg-green-100 text-green-600 flex items-center justify-center hover:bg-green-600 hover:text-white transition-colors">
                ...
                <form id="contact-form" onsubmit="handleContactSubmit(event)" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="name" name="name" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all" placeholder="Your name">
                        </div>
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email *</label>
                            <input type="email" id="email" name="email" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all" placeholder="your@email.com">
                        </div>
                    </div>
                    
                    <div>
                        <label for="phone" class="block text-sm font-medium text-gray-700 mb-2">Phone</label>
                        <input type="tel" id="phone" name="phone" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all" placeholder="+1 (555) 123-4567">
                    </div>
                    
                    <div>
                        <label for="subject" class="block text-sm font-medium text-gray-700 mb-2">Subject *</label>
                        <input type="text" id="subject" name="subject" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all" placeholder="What's this about?">
                    </div>
                    
                    <div>
                        <label for="message" class="block text-sm font-medium text-gray-700 mb-2">Message *</label>
                        <textarea id="message" name="message" rows="5" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all resize-none" placeholder="Tell us more about your inquiry..."></textarea>
                    </div>
                    
                    <button type="submit" class="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2">
        ...
        <div class="bg-white rounded-xl border shadow-sm overflow-hidden">
            <div class="h-96 bg-gray-200 flex items-center justify-center">
                <div class="text-center text-gray-500">
                    <i class="fas fa-map-marked-alt text-6xl mb-4 text-green-600"></i>
                    <p class="text-lg">Map Location</p>
                    <p class="text-sm">123 Shopping Street, City, State 12345</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-screen-2xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white rounded-xl border shadow-sm p-6">
                ...
                <p class="text-gray-600 text-sm">Once your order is confirmed, you'll receive a tracking number via email. You can also check your order status in your account dashboard.</p>
            </div>
            ...
            <div class="bg-white rounded-xl border shadow-sm p-6">
                ...
                <p class="text-gray-600 text-sm">We offer a 30-day return policy on most items. Items must be in original condition and packaging. Please contact us for a return authorization.</p>
            </div>
            ...
            <div class="bg-white rounded-xl border shadow-sm p-6">
                ...
                <p class="text-gray-600 text-sm">Yes! We offer free shipping on orders over $50. Standard shipping takes 3-5 business days, and express shipping is available for an additional fee.</p>
            </div>
            ...
            <div class="bg-white rounded-xl border shadow-sm p-6">
                ...
                <p class="text-gray-600 text-sm">If you need to modify your order, please contact us as soon as possible. We can help you make changes before your order ships.</p>
            </div>
        </div>
    </div>
</section>
...
<!-- Cart Modal (reuse from other pages) -->
